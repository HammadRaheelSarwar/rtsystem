...
- Inquiries: `GET/POST /inquiries`, `GET/PUT/DELETE /inquiries/:id`, `PATCH /inquiries/:id/status`, `PATCH /inquiries/:id/assignment`, `POST /inquiries/:id/archive`
...
- Queries: `POST/GET /inquiries/:id/design-queries`, `PATCH /design-queries/:id`, `POST /design-queries/:id/{respond|resolve|reopen}`, `GET /design-queries/:id/history`
...
- Administration: `GET /admin/audit-logs`, `GET /admin/configuration`, `POST/PUT /admin/system-settings`, `POST/PUT /admin/approval-rules`
- Master data: `GET/POST/PUT /master/{roles|departments}`
